...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const appStyles = StyleSheet.create({
    ...
    background: {
      backgroundColor: toAppColor ? '#8EDFEB' : (theme === 'dark' ? darkBackground : lightBackground),
    },
    inverseBackground: {
  ...
  return (
    ...
    >
      <UserContext.Provider
        value={{ usersData, searchText, setSearchText, addUserToData, findUserByEmail, updateUserByEmail, getUserData }}
      >
